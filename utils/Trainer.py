...
class Trainer():
    def __init__(self,model,lr,dataloaders,save_param_path,writer,early_stop,epoches,model_name,save_predict_result_path,beta_c,beta_n,scheduler_option=False,save_threshold = 0.7, start_epoch = 0):
        self.model = model
        # self.device = device
